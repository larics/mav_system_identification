...
clc
clear all
log = Ardupilog('/home/lmark/Documents/bags/helvetis/logs_paolo_flight/2019-09-05 16-29-21.bin');
%%

imu_data.rpy = [log.ATT.Roll, log.ATT.Pitch, log.ATT.Yaw]';
attitude_cmd.rpy = [log.ATT.DesRoll, log.ATT.DesPitch, log.ATT.DesYaw]';

t_start = log.ATT.TimeS(1);
imu_data.t = log.ATT.TimeS - t_start;
attitude_cmd.t = log.ATT.TimeS - t_start;
%% plot
figure(1);
ax = axes;
